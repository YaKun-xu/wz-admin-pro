...
--
-- Host: localhost    Database: zhanli
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='小程序配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  `card_key_id` int DEFAULT NULL COMMENT '关联卡密表ID',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `shop_card_keys` VALUES (1,6,'1',0,NULL,NULL);
...
CREATE TABLE `shop_faqs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `product_id` int DEFAULT NULL COMMENT '关联商品ID（NULL表示通用FAQ）',
...
CREATE TABLE `shop_modify_steps` (
  `id` int NOT NULL AUTO_INCREMENT,
  `product_id` int DEFAULT NULL COMMENT '关联商品ID（NULL表示通用步骤）',
...
CREATE TABLE `shop_products` (
  ...
  `product_type` tinyint DEFAULT '1' COMMENT '商品类型：1-普通商品，2-卡密商品',
...
CREATE TABLE `shop_tutorials` (
  `id` int NOT NULL AUTO_INCREMENT,
  `product_id` int DEFAULT NULL COMMENT '关联商品ID（NULL表示通用教程）',
...
CREATE TABLE `shop_videos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `product_id` int DEFAULT NULL COMMENT '关联商品ID（NULL表示通用视频）',
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='网站信息配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'zhanli'
--

--
-- Dumping routines for database 'zhanli'
--
...
-- Dump completed on 2025-11-05  3:45:44
